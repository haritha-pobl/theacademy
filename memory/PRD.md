...
- Hero widened + mobile scroll hardening (2026-06, testing agent 100% pass): .wrap 1280px, hero fills content column; siteShell reveal is CSS-only (no JS dependency), .reveal no-JS-safe via html.js class, assets cache-busted ?v=3, pace-card radio horizontal-overflow fixed
- Facebook Pixel (id 1509252477674429) added to <head> of all 6 public pages — verified fbq initialises and PageView fires; admin.html intentionally excluded (script: /app/memory/add_fb_pixel.py) (2026-06)
